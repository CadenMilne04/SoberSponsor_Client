...
function JournalNewEntry(props) {
    ...
    return (
        <div className='grid grid-cols-1 gap-2 m-auto p-3 bg-white w-full rounded-md'>
            <h2>New entry:</h2>
            ...
            <textarea value={newBody} onChange={(e) => {setNewBody(e.target.value)}} className='bg-gray-50 p-2' rows="5" placeholder="How are you feeling?"></textarea>
